...
const PokeDetail: React.FC = () => {
    ...
    if (!name || !data) return <div>Not Found</div>;
        ...
        <MobileWrapper>
            ...
            <div className="w-full h-full px-6 py-8">
                <div className="w-full relative mb-3">
                    <img src={data.artworkFront} alt="pokemon image"/>
                </div>
          ...
          <span className="text-4xl text-white font-bold leading-[30px] capitalize">
            {data.name}
                ...
                <div className="rounded-2xl bg-dark-rift p-4 flex flex-col gap-2">
                    ...
                    <div
                        className=" items-center flex gap-2 font-bold leading-7 pb-[10px] text-white border-b-[1px] border-chronicle">
                        <div className="text-2xl ">{data.health}</div>
                        <div className="text-base font-normal">from 100</div>
                    </div>
                    <div className="flex">
                        <div className="flex flex-col gap-1 basis-1/2">
                            <span className="leading-[14px] text-velvet-robe">Attack</span>
                            <span className="text-white text-2xl font-bold">{data.attack}</span>
                        </div>
                        <div className="flex flex-col gap-1 basis-1/2">
                            <span className="leading-[14px] text-velvet-robe">Defense</span>
                            <span className="text-white text-2xl font-bold">{data.defense}</span>
                        </div>
                    </div>
                </div>
            </div>
